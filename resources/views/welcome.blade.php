    ...
    <section class="rounded-3xl border border-white/10 bg-white/5 p-4 space-y-4">
        ...
        <div>
            ...
            <div class="mt-3 flex gap-2">
                <button id="btnStart" class="px-4 py-2 rounded-xl bg-emerald-500 text-black font-semibold">Start</button>
        ...
        <div>
            ...
            <div class="mt-2 flex gap-2">
                <button id="btnModeIn"
                        class="flex-1 rounded-xl bg-sky-400 text-black py-2 font-semibold">
                    Check-In
                </button>
                <button id="btnModeOut"
                        class="flex-1 rounded-xl bg-white/10 py-2 font-semibold">
                    Check-Out
                </button>
            </div>
        </div>
        ...
        <button id="btnCapture"
                class="w-full rounded-2xl bg-emerald-500 py-3 text-black font-semibold">
            Capture Attendance
        </button>
