            ...
            <div class="grid gap-6 lg:grid-cols-12">
                ...
                <div class="grid gap-6">
                    ...
                    <div class="mt-3 grid gap-2">
                        ...
                        <input id="enrollName" type="text" placeholder="e.g., Juan Dela Cruz" class="w-full rounded-xl bg-white/10 px-3 py-2 text-sm outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60" />
                        <input id="enrollEmail" type="email" placeholder="Email" class="w-full rounded-xl bg-white/10 px-3 py-2 text-sm outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60" />
                        <input id="enrollPassword" type="password" placeholder="Password" class="w-full rounded-xl bg-white/10 px-3 py-2 text-sm outline-none ring-1 ring-white/10 focus:ring-2 focus:ring-emerald-400/60" />
                        <div class="flex flex-wrap items-center gap-2 pt-1">
                        <button id="btnEnroll" class="rounded-xl bg-emerald-500/90 px-3 py-2 text-sm font-semibold text-slate-950 hover:bg-emerald-400">Capture & Save</button>
                        <button id="btnExportProfiles" class="rounded-xl bg-white/10 px-3 py-2 text-sm font-semibold hover:bg-white/15">Export profiles (JSON)</button>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="text-xs font-semibold text-slate-200">Enrolled</div>
                        <div class="text-[11px] text-slate-400"><span id="enrolledCount">0</span> profiles</div>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        CSV columns: <span class="font-mono">name, time_in, time_out, photo_data_url</span>.
                        </div>
                    </div>
                    </div>
